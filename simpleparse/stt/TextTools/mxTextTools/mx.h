...
#define Py_ReturnOnError(errortype, errorstr) \
   {                                          \
      PyErr_SetString(errortype, errorstr);   \
      return NULL;                            \
   }

#define Py_Assert(x, errortype, errorstr)      \
   {                                           \
      if (!(x))                                \
      {                                        \
         PyErr_SetString(errortype, errorstr); \
...
#define Py_AssertWith2Args(x, errortype, errorstr, a1, a2) \
   {                                                       \
      if (!(x))                                            \
      {                                                    \
         PyErr_Format(errortype, errorstr, a1, a2);        \
         goto onError;                                     \
      }                                                    \
   }
#define Py_AssertWith3Args(x, errortype, errorstr, a1, a2, a3) \
   {                                                           \
      if (!(x))                                                \
      {                                                        \
         PyErr_Format(errortype, errorstr, a1, a2, a3);        \
         goto onError;                                         \
      }                                                        \
   }
...
#define Py_ErrorWithArg(errortype, errorstr, a1) \
   {                                             \
      PyErr_Format(errortype, errorstr, a1);     \
      goto onError;                              \
   }
#define Py_ErrorWith2Args(errortype, errorstr, a1, a2) \
   {                                                   \
      PyErr_Format(errortype, errorstr, a1, a2);       \
      goto onError;                                    \
   }
#define Py_ErrorWith3Args(errortype, errorstr, a1, a2, a3) \
   {                                                       \
      PyErr_Format(errortype, errorstr, a1, a2, a3);       \
      goto onError;                                        \
   }
...
#define Py_DELETE(x)                                                                                                        \
   {                                                                                                                        \
      if (x->ob_refcnt > 1)                                                                                                 \
         mxDebugPrintf("[%s:%5i] Py_DELETE( " #x " ) WARNING: Refcount = %i > 1\n", __FILE__, __LINE__, (int)x->ob_refcnt); \
      Py_DECREF(x);                                                                                                         \
   }
...
#define Py_DEC_REF(x) \
   {                  \
      Py_XDECREF(x);  \
      x = 0;          \
   } /* doing this once too often doesn't hurt */
...
#define Py_GetArgObject(a)                                                         \
   {                                                                               \
      a = args;                                                                    \
      if (!a)                                                                      \
      {                                                                            \
         PyErr_SetString(PyExc_TypeError, "function/method requires an argument"); \
         goto onError;                                                             \
      }                                                                            \
   }
#define Py_GetSingleArg(format, a1)        \
   {                                       \
      if (!PyArg_Parse(args, format, &a1)) \
         goto onError;                     \
   }

/* For functions with new style args: */
#define Py_GetArg(format, a1)                   \
   {                                            \
      if (!PyArg_ParseTuple(args, format, &a1)) \
         goto onError;                          \
   }
#define Py_Get2Args(format, a1, a2)                  \
   {                                                 \
      if (!PyArg_ParseTuple(args, format, &a1, &a2)) \
         goto onError;                               \
   }
#define Py_Get3Args(format, a1, a2, a3)                   \
   {                                                      \
      if (!PyArg_ParseTuple(args, format, &a1, &a2, &a3)) \
         goto onError;                                    \
   }
#define Py_Get4Args(format, a1, a2, a3, a4)                    \
   {                                                           \
      if (!PyArg_ParseTuple(args, format, &a1, &a2, &a3, &a4)) \
         goto onError;                                         \
   }
#define Py_Get5Args(format, a1, a2, a3, a4, a5)                     \
   {                                                                \
      if (!PyArg_ParseTuple(args, format, &a1, &a2, &a3, &a4, &a5)) \
         goto onError;                                              \
   }
#define Py_Get6Args(format, a1, a2, a3, a4, a5, a6)                      \
   {                                                                     \
      if (!PyArg_ParseTuple(args, format, &a1, &a2, &a3, &a4, &a5, &a6)) \
         goto onError;                                                   \
   }
#define Py_Get7Args(format, a1, a2, a3, a4, a5, a6, a7)                       \
   {                                                                          \
      if (!PyArg_ParseTuple(args, format, &a1, &a2, &a3, &a4, &a5, &a6, &a7)) \
         goto onError;                                                        \
   }
#define Py_Get8Args(format, a1, a2, a3, a4, a5, a6, a7, a8)                        \
   {                                                                               \
      if (!PyArg_ParseTuple(args, format, &a1, &a2, &a3, &a4, &a5, &a6, &a7, &a8)) \
         goto onError;                                                             \
   }
...
*/
#define Py_KeywordGetArg(keywords, format, a1)                            \
   {                                                                      \
      if (!PyArg_ParseTupleAndKeywords(args, kws, format, keywords, &a1)) \
         goto onError;                                                    \
   }
#define Py_KeywordGet2Args(keywords, format, a1, a2)                           \
   {                                                                           \
      if (!PyArg_ParseTupleAndKeywords(args, kws, format, keywords, &a1, &a2)) \
         goto onError;                                                         \
   }
#define Py_KeywordGet3Args(keywords, format, a1, a2, a3)                            \
   {                                                                                \
      if (!PyArg_ParseTupleAndKeywords(args, kws, format, keywords, &a1, &a2, &a3)) \
         goto onError;                                                              \
   }
#define Py_KeywordGet4Args(keywords, format, a1, a2, a3, a4)                             \
   {                                                                                     \
      if (!PyArg_ParseTupleAndKeywords(args, kws, format, keywords, &a1, &a2, &a3, &a4)) \
         goto onError;                                                                   \
   }
#define Py_KeywordGet5Args(keywords, format, a1, a2, a3, a4, a5)                              \
   {                                                                                          \
      if (!PyArg_ParseTupleAndKeywords(args, kws, format, keywords, &a1, &a2, &a3, &a4, &a5)) \
         goto onError;                                                                        \
   }
#define Py_KeywordGet6Args(keywords, format, a1, a2, a3, a4, a5, a6)                               \
   {                                                                                               \
      if (!PyArg_ParseTupleAndKeywords(args, kws, format, keywords, &a1, &a2, &a3, &a4, &a5, &a6)) \
         goto onError;                                                                             \
   }
#define Py_KeywordGet7Args(keywords, format, a1, a2, a3, a4, a5, a6, a7)                                \
   {                                                                                                    \
      if (!PyArg_ParseTupleAndKeywords(args, kws, format, keywords, &a1, &a2, &a3, &a4, &a5, &a6, &a7)) \
         goto onError;                                                                                  \
   }
#define Py_KeywordGet8Args(keywords, format, a1, a2, a3, a4, a5, a6, a7, a8)                                 \
   {                                                                                                         \
      if (!PyArg_ParseTupleAndKeywords(args, kws, format, keywords, &a1, &a2, &a3, &a4, &a5, &a6, &a7, &a8)) \
         goto onError;                                                                                       \
   }
...
*/
#define Py_KeywordsGetArg(format, a1)                                    \
   {                                                                     \
      static char *kwslist[] = {#a1, NULL};                              \
      if (!PyArg_ParseTupleAndKeywords(args, kws, format, kwslist, &a1)) \
         goto onError;                                                   \
   }
#define Py_KeywordsGet2Args(format, a1, a2)                                   \
   {                                                                          \
      static char *kwslist[] = {#a1, #a2, NULL};                              \
      if (!PyArg_ParseTupleAndKeywords(args, kws, format, kwslist, &a1, &a2)) \
         goto onError;                                                        \
   }
#define Py_KeywordsGet3Args(format, a1, a2, a3)                                    \
   {                                                                               \
      static char *kwslist[] = {#a1, #a2, #a3, NULL};                              \
      if (!PyArg_ParseTupleAndKeywords(args, kws, format, kwslist, &a1, &a2, &a3)) \
         goto onError;                                                             \
   }
#define Py_KeywordsGet4Args(format, a1, a2, a3, a4)                                     \
   {                                                                                    \
      static char *kwslist[] = {#a1, #a2, #a3, #a4, NULL};                              \
      if (!PyArg_ParseTupleAndKeywords(args, kws, format, kwslist, &a1, &a2, &a3, &a4)) \
         goto onError;                                                                  \
   }
#define Py_KeywordsGet5Args(format, a1, a2, a3, a4, a5)                                      \
   {                                                                                         \
      static char *kwslist[] = {#a1, #a2, #a3, #a4, #a5, NULL};                              \
      if (!PyArg_ParseTupleAndKeywords(args, kws, format, kwslist, &a1, &a2, &a3, &a4, &a5)) \
         goto onError;                                                                       \
   }
#define Py_KeywordsGet6Args(format, a1, a2, a3, a4, a5, a6)                                       \
   {                                                                                              \
      static char *kwslist[] = {#a1, #a2, #a3, #a4, #a5, #a6, NULL};                              \
      if (!PyArg_ParseTupleAndKeywords(args, kws, format, kwslist, &a1, &a2, &a3, &a4, &a5, &a6)) \
         goto onError;                                                                            \
   }
#define Py_KeywordsGet7Args(format, a1, a2, a3, a4, a5, a6, a7)                                        \
   {                                                                                                   \
      static char *kwslist[] = {#a1, #a2, #a3, #a4, #a5, #a6, #a7, NULL};                              \
      if (!PyArg_ParseTupleAndKeywords(args, kws, format, kwslist, &a1, &a2, &a3, &a4, &a5, &a6, &a7)) \
         goto onError;                                                                                 \
   }
#define Py_KeywordsGet8Args(format, a1, a2, a3, a4, a5, a6, a7, a8)                                         \
   {                                                                                                        \
      static char *kwslist[] = {#a1, #a2, #a3, #a4, #a5, #a6, #a7, #a8, NULL};                              \
      if (!PyArg_ParseTupleAndKeywords(args, kws, format, kwslist, &a1, &a2, &a3, &a4, &a5, &a6, &a7, &a8)) \
         goto onError;                                                                                      \
   }
...
#define Py_ReturnNone()   \
   {                      \
      Py_INCREF(Py_None); \
      return Py_None;     \
   }
#define Py_ReturnTrue()   \
   {                      \
      Py_INCREF(Py_True); \
      return Py_True;     \
   }
#define Py_ReturnFalse()   \
   {                       \
      Py_INCREF(Py_False); \
      return Py_False;     \
   }
...
/* Add a C function/method cname to the module dict as pyname; no
   doc-string */
#define Py_MethodListEntryAny(pyname, cname)   \
   {                                           \
      pyname, (PyCFunction)cname, METH_VARARGS \
   }

/* Add a C function/method cname to the module dict as pyname; the
   function can use varargs */
#define Py_MethodListEntry(pyname, cname)                         \
   {                                                              \
      pyname, (PyCFunction)cname, METH_VARARGS, cname##_docstring \
   }
...
/* Add a C function/method cname to the module dict as pyname; the
   ...
   itself. */
#ifdef METH_NOARGS
#define Py_MethodListEntryNoArgs(pyname, cname)                  \
   {                                                             \
      pyname, (PyCFunction)cname, METH_NOARGS, cname##_docstring \
   }
#else
#define Py_MethodListEntryNoArgs(pyname, cname)        \
   {                                                   \
      pyname, (PyCFunction)cname, 0, cname##_docstring \
   }
#endif
...
/* Add a C function/method cname to the module dict as pyname; the
   ...
   understood.
   */
#define Py_MethodListEntrySingleArg(pyname, cname)     \
   {                                                   \
      pyname, (PyCFunction)cname, 0, cname##_docstring \
   }

/* Add a C function/method that uses keywords to the module dict */
#define Py_MethodWithKeywordsListEntry(pyname, cname)                             \
   {                                                                              \
      pyname, (PyCFunction)cname, METH_VARARGS | METH_KEYWORDS, cname##_docstring \
   }
