...
class ParserGenerationTests(unittest.TestCase):
    ...
    def testGenPosReptOpt1(self):
        self.doBasicTest(
            ...
            's',
            'aammmab',
            (1, [("something", 0, 1, NullResult),
                 ("something", 1, 2, NullResult)], 2)
        )
...
class CallTests(unittest.TestCase):
    ...
    def test_basic_call(self):
        ...
        self.parse("""
            ...
            b := "b"
        """, 'x', 'abba', source)
        assert source.results == [('a', 'a'), ('b', 1, 2), ('b', 2, 3), ('a', 'a'),
                                  ], """Method source methods were not called, or called improperly:\n%s""" % (source.results,)
    ...
    def test_AppendToTagObj(self):
        ...
        self.parse("""
            ...
            d := 'd'
        """, 'x', 'ddd', source)
        assert source._o_d == [(None, 0, 1, NullResult), (None, 1, 2, NullResult), (None, 2, 3, NullResult)
                               ], """Method source methods were not called, or called improperly:\n%s""" % (source._o_d,)
