...
class MXFlagTests(unittest.TestCase):
    ...
    def testAppendToTagobj1(self):
        ...
        assert tag.successful == (
            None, 0, 6, None), "TagObject's append was called with %s" % (repr(tag.successful),)
    ...
    def testAppendToTagobj2(self):
        ...
        assert tag[0] == (None, 0, 6, None), "TagObject's append was called with %s" % (
            repr(tag.successful),)
